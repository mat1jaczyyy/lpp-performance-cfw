...
u8 syx_device_inquiry[syx_device_inquiry_length];
u8 syx_device_inquiry_response[syx_device_inquiry_response_length];

u8 syx_challenge[syx_challenge_length];
u8 syx_challenge_response[syx_challenge_response_length];

u8 syx_mode_selection[syx_mode_selection_length];
u8 syx_mode_selection_response[syx_mode_selection_response_length];

u8 syx_live_layout_selection[syx_live_layout_selection_length];
u8 syx_live_layout_selection_response[syx_live_layout_selection_response_length];

u8 syx_standalone_layout_selection[syx_standalone_layout_selection_length];
u8 syx_standalone_layout_selection_response[syx_standalone_layout_selection_response_length];

u8 syx_led_single[syx_led_single_length];
u8 syx_led_column[syx_led_column_length];
u8 syx_led_row[syx_led_row_length];
u8 syx_led_all[syx_led_all_length];

u8 syx_led_flash[syx_led_flash_length];
u8 syx_led_pulse[syx_led_pulse_length];

u8 syx_led_rgb[syx_led_rgb_length];
u8 syx_led_grid[syx_led_grid_length];

u8 syx_text[syx_text_length];
u8 syx_text_response[syx_text_response_length];

u8 syx_palette_start[syx_palette_start_length];
u8 syx_palette_write[syx_palette_write_length];
u8 syx_palette_end[syx_palette_end_length];

u8 syx_palette_text[syx_palette_text_length];

u8 syx_fader[syx_fader_length];
